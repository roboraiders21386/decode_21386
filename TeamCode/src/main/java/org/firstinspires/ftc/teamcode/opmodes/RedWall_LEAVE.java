...
@Autonomous(name = "red wall LEAVE only", group = "Autonomous")
public class RedWall_LEAVE extends OpMode {

    private Follower follower;
    private Timer opmodeTimer;
    private int pathState;

    // RED Wall Starting Position and Park Position


    //Updated co-ordinates to be on the RED side
    private final Pose startPose = new Pose(84.000, 8.000, Math.toRadians(270));
    private final Pose parkPose = new Pose(84.000, 30, Math.toRadians(270));
